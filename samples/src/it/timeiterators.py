...
if __name__ == '__main__':
    ...
    print
    '20*take(50, hamming-new(2,3,5)) : ', result
    ...
    result = t.repeat(2, 20)
    print
    '20*take(50, hamming-classic(2,3,5)) : ', result
    ...
    result = t.repeat(2, 20)
    print
    '20*take(100, product-new(isin(), icos())) : ', result
    ...
    result = t.repeat(2, 20)
    print
    '20*take(100, product-classic(isin(), icos())) : ', result
    ...
    result = t.repeat(2, 20)
    print
    '20*take(100, inverse-classic(iexp())) : ', result
